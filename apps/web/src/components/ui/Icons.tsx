...
export function IconCodex({ size = 16, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconWorldara({ size = 16, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M12 32h40M32 12v40M16 22c10 4 22 4 32 0M16 42c10-4 22-4 32 0M24 14c-7 12-7 24 0 36M40 14c7 12 7 24 0 36" stroke="currentColor" strokeWidth="3" strokeLinecap="round" />
      <path d="M32 31.5 40 27.5v14L32 37.5z" fill="var(--brand-paper, #f3e6d0)" stroke="none" />
    </svg>
  );
}

export function IconQuill({ size = 16, className = '', ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
      <path d="M20.7 3.3c-4.8-.5-9.5 1.2-12.8 4.6-2.8 2.8-4.2 6.6-3.9 10.5 3.9.3 7.7-1.1 10.5-3.9 3.4-3.3 5.1-8 4.6-12.8" />
      <path d="M4 20 15 9M8 16h6M11 13v-3" />
    </svg>
  );
}
...
export function IconBook({ size = 16, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconNetwork({ size = 16, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconSchema({ size = 16, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconUnlock({ size = 16, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconDiff({ size = 16, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
